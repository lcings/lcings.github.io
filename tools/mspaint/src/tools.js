...
tools = [{
	name: "自由选择",
	description: "选择图片的自由格式部分，以移动、复制或编辑.",
	...
	name: "橡皮檫",
	description: "使用选定的橡皮形状，擦除图片的一部分.",
	cursor: ["precise", [16, 16], "crosshair"],
